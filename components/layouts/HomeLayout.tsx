...
const smartClientImage = {
  src: "http://localhost:1337/uploads/0_0_24_1408f7c4a3.png",
...
const smartClientImage1 = {
  src: "http://localhost:1337/uploads/image_13177a95d8.png",
  alt: "Two stylized cats with thought bubble and heart, surrounded by swirling white lines",
  width: 500,
  height: 1000
};
...
const testimonialImage = {
  src: "http://localhost:1337/uploads/unsplash_W_No_Ln_Jo7t_S8_0302f0d8b2.png",
...
const flipSectionImage1 = {
  src: "http://localhost:1337/uploads/0_0_10_c658a142f7.png",
...
const flipSectionImage = {
  src: "http://localhost:1337/uploads/0_1_17_57bd95d854.png",
  alt: "Three cats in a magical forest setting with glowing elements and dreamy atmosphere",
  width: 500,
  height: 500
};
...
const features = [
  {
    icon: "http://localhost:1337/uploads/one_On_One_4f43622e5b.svg",
    title: "One-on-One",
    description: ["Live agent", "Fully Vetted"]
  },
  {
    icon: "http://localhost:1337/uploads/no_Strings_6f7c4d97d5.svg",
    title: "No Commitment",
    description: ["Pay Model", "Date-to-date"]
  },
  {
    icon: "http://localhost:1337/uploads/International_8920f8e443.svg",
    title: "International Matching",
    description: ["Big pond", "Access geofenced prospects"]
  },
  {
    icon: "http://localhost:1337/uploads/Demographics_b53f4ea05f.svg",
    title: "Specific Demographic",
    description: ["Up to 500 Preferences", "Tailored"]
  },
  {
    icon: "http://localhost:1337/uploads/Component_15_3c0444dc39.svg",
    title: "And More",
...
const catIllustrationImages = {
  smallImage: {
    src: "http://localhost:1337/uploads/image_281_4955cb348c.png",
    alt: "Three stylized cats with glowing pink elements and magical atmosphere",
    width: 400,
    height: 300
  },
  smallImage1: {
    src: "http://localhost:1337/uploads/image_284_4de832f1d4.png",
    alt: "Three stylized cats with glowing pink elements and magical atmosphere",
    width: 400,
    height: 300
  },
  footerImage: {
    src: "http://localhost:1337/uploads/image_424_374014975b.png",
