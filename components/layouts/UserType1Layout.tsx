...
import GiftShopModal from '@/components/modals/GiftShopModal';
  ...
  const catIllustrationImages = {
    smallImage: {
      src: "http://localhost:1337/uploads/image_430_3d0186fe03.png",
      alt: "Three stylized cats with glowing pink elements and magical atmosphere",
      width: 400,
      height: 300
    },
     smallImage1: {
      src: "http://localhost:1337/uploads/image_279_70ac8d7b67.png",
      alt: "Three stylized cats with glowing pink elements and magical atmosphere",
      width: 400,
      height: 300
    },
    largeImage: {
      src: "http://localhost:1337/uploads/0_3_17_71851fa55c.png",
  ...
  const testimonialImage = {
    src: "http://localhost:1337/uploads/unsplash_W_No_Ln_Jo7t_S8_1129bba579.png",
...
const UserType1Layout = () => {
  ...
  const smartClientImage = { src: 'http://localhost:1337/uploads/image_352_d0074b9b0b.png', alt: 'Smart Client Illustration', width: 500, height: 400 };
  
  const dashboardImages = {
    backgroundImage: { src: 'http://localhost:1337/uploads/Untitled_3_1_953cb845ec.png', alt: 'Dashboard Background'},
    phoneImage: { src: 'http://localhost:1337/uploads/Rectangle_44573f115b.png', alt: 'Phone Mockup'},
  };
  const catFeatureImage = { src: 'http://localhost:1337/uploads/image_292_2f1b34f0c9.png', alt: 'Cat illustration with glowing elements and magical atmosphere', width: 800, height: 600 };
