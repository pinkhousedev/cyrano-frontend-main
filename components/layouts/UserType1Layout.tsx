...
import { getImageUrl } from '@/lib/utils';
  ...
  const catIllustrationImages = {
    smallImage: {
      src: getImageUrl("/uploads/image_430_3d0186fe03.png"),
      alt: "Three stylized cats with glowing pink elements and magical atmosphere",
      width: 400,
      height: 300
    },
     smallImage1: {
      src: getImageUrl("/uploads/image_279_70ac8d7b67.png"),
      alt: "Three stylized cats with glowing pink elements and magical atmosphere",
      width: 400,
      height: 300
    },
    largeImage: {
      src: getImageUrl("/uploads/0_3_17_71851fa55c.png"),
  ...
  const testimonialImage = {
    src: getImageUrl("/uploads/unsplash_W_No_Ln_Jo7t_S8_1129bba579.png"),
...
const UserType1Layout = () => {
  ...
  const smartClientImage = { src: getImageUrl('/uploads/image_352_d0074b9b0b.png'), alt: 'Smart Client Illustration', width: 500, height: 400 };
