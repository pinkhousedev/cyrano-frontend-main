...
const smartClientImage = {
    src: "https://cyrano-pamphlet-backend-cyiq.onrender.com/uploads/image_407_4408fc43ae.png",
    alt: "Two stylized cats with thought bubble and heart, surrounded by swirling white lines",
    width: 500,
    height: 500
  };
...
const flipSectionImage1 = {
  src: "https://cyrano-pamphlet-backend-cyiq.onrender.com/uploads/0_0_10_4498e85dae.png",
  ...
  const catIllustrationImages = {
    largeImage: {
      src: "https://cyrano-pamphlet-backend-cyiq.onrender.com/uploads/0_0_9_4b7230cd1b.png",
