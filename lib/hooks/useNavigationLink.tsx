...
let navigationCache: GlobalData | null = null;
let cacheTimestamp: number = 0;
const CACHE_DURATION = 5 * 60 * 1000; // 5 minutes

export function useNavigationLink() {
  const [data, setData] = useState<GlobalData | null>(navigationCache);
  const [loading, setLoading] = useState(!navigationCache);
